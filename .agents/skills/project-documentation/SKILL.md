...
- Writing privacy, security, local storage, telemetry, tracking, encryption, or wallet/data-handling claims.
...
| Does privacy, storage, telemetry, or security posture change? | Verify claims against implementation and document current limits, data locations, and user controls. |
...
- Verify claims such as "private", "secure", "local-only", "encrypted", or "no tracking" against current implementation.
...
| Privacy and data handling | Browser storage, public relay data, telemetry, third-party services, encryption limits, and user controls | `docs/cuenta-y-acceso`, `docs/protocolo`, or `docs/faq` |
...
| Making privacy/security claims without checking implementation | Verify storage, logs, telemetry, artifacts, and third-party services first. |
